...
function setupEmptyBoard() {        
    $(".board").append('<thead><tr><th style="background-color:#adadad; color:white; padding:8px; border: 2px solid black; border-radiuus:12px" onclick="selectPlayers();">Players</th></tr></thead><tbody></tbody>');
...
function updateElapsedTime() {
    ...
    elapsedTimeSecs++;
    var elapsedTimeH = Math.floor(elapsedTimeSecs / 3600);
    var elapsedTimeM = Math.floor( (elapsedTimeSecs % 3600) / 60);
    var elapsedTimeS = Math.floor( (elapsedTimeSecs % 3600) % 60);
